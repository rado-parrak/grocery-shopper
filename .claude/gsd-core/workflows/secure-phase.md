...
```
Agent(
  prompt="Read /home/user/grocery-shopper/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/grocery-shopper/.claude/gsd-core/templates/SECURITY.md`
