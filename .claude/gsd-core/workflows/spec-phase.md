...
ones). Reference: @/home/user/grocery-shopper/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/user/grocery-shopper/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/user/grocery-shopper/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/user/grocery-shopper/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/user/grocery-shopper/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/user/grocery-shopper/.claude/gsd-core/templates/spec.md.
