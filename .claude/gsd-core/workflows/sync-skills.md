...
INSTALL_JS_GLOBAL="/home/user/grocery-shopper/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/user/grocery-shopper/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
