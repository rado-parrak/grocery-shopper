...
Reference full template: `/home/user/grocery-shopper/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/grocery-shopper/.claude/gsd-core/templates/state.md`.
