...
Use template from `/home/user/grocery-shopper/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/home/user/grocery-shopper/.claude/gsd-core/templates/UI-SPEC.md`
