...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/grocery-shopper/.claude/.gsd-surface.json`
(sibling to `/home/user/grocery-shopper/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/grocery-shopper/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/grocery-shopper/.claude/skills`).
...
`/home/user/grocery-shopper/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/grocery-shopper/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/grocery-shopper/.claude/.gsd-surface.json`
Install profile marker: `/home/user/grocery-shopper/.claude/.gsd-profile`
Skill dirs: `/home/user/grocery-shopper/.claude/skills/gsd-*/`
Engine module: `/home/user/grocery-shopper/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/grocery-shopper/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
