...
<execution_context>
@/home/user/grocery-shopper/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/grocery-shopper/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
