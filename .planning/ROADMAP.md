...
- [ ] 02-01-PLAN.md — quick-add SKILL.md: bilingual cascade → confirmation artifact → idempotent write → Czech audit, with budget/substitution/degradation safety rails [CASC-01..06, CONF-01..05, BUDG-01..03, SUBS-01, DEGR-01,02, AUDT-01, UX-01,02,03, QADD-01,02]
